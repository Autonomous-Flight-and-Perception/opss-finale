...
class YOLOv8Detector:
    def __init__(self, model_path: str = "yolov8n.pt", conf_threshold: float = 0.55):
...
def process_frame_bgr(bgr: np.ndarray, thresh: float = 0.55, persons_only: bool = True) -> Tuple[np.ndarray, List[Dict]]:
    """
